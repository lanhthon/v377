<!-- ========================================
     FILE: pages/quan_ly_phieu_chi.php
     ======================================== -->
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="container">
        <h1><i class="fa fa-file-invoice-dollar"></i> Quản Lý Phiếu Chi</h1>

        <div class="controls-container">
            <div class="filter-controls">
                <input id="filter-date-from" type="date">
                <input id="filter-date-to" type="date">
                <select id="filter-loai-cp">
            ...
            <div class="action-buttons">
                <button id="add-btn" class="action-button" style="background-color: var(--danger-color);">
                    <i class="fa fa-plus"></i> Thêm Phiếu Chi
                </button>
        ...
        <div id="phieu-chi-table"></div>
    </div>

    <div id="phieu-chi-modal" class="modal"></div>
    <div id="toast"></div>
